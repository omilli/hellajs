...
title: Styling
description: Flexible styling with CSS-in-JS support, automatic scoping and reactive capabilities.
---
...
HellaJS supports both traditional CSS classes and advanced CSS-in-JS styling approaches. Use regular CSS classes for existing stylesheets or CSS-in-JS for dynamic, reactive styling that automatically responds to state changes.

## Traditional CSS Classes

Apply CSS classes to elements using the `class` attribute, with full support for reactive class names and arrays.
...
Every CSS object automatically receives a unique class name based on its content hash. This ensures complete isolation without any additional configuration.
...
HellaJS provides a dedicated `cssVars` function for managing CSS custom properties and theming.
...
The HellaJS styling system demonstrates how modern CSS-in-JS can achieve both developer experience and runtime performance through intelligent design.
