...
title: Reactivity
description: Fine-grained reactivity system enabling automatic and efficient UI updates.
---

# Reactivity

HellaJS uses fine-grained reactivity to create direct connections between data and DOM elements, enabling automatic UI updates.
