...
- **Unclosed tags.** Auto-closed at EOF: children were appended to their open parent at open time, so only the outermost unclosed node (`stack[0]`) is flushed as a root. No throw.
