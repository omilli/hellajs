...
(async () => {
  try {
    const reserved = [
      "mount", "forEach", "html", "show", "signal", "effect", "computed", "batch", "untracked", "store", "resource", "router", "navigate", "route", "css", "cssVar", "cssReset", "cssVarReset", "slot", "hole", "mergeProps"
    ];
