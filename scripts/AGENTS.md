<scripts-instructions>
  ...
  | `plans/run.ts` | Per-unit orchestration over worktree venues: fresh instance, worktree-copy marker gate, checkpoints, failure gate, merge instance, summary, SIGINT |
