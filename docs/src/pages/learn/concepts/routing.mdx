...
The [navigate](/reference/router/navigate) function provides programmatic routing with support for parameters, query strings, scroll control, and metadata.
...
**Scroll Priority:** Inline `scroll` > Route-level `scroll` > Global `scrollBehavior`
