...
Static components render fixed elements that don't change over time.
...
Use `onDestroy` for external resources. Reactive effects and event handlers are automatically cleaned up.
