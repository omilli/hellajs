...
description: "The global JSX namespace is HellaJS's own, declared in the dom barrel (declare global block) — JSX.Element = HellaNode & RenderFn; the tsconfig jsx: react-jsx value is a red herring pointing at React."
