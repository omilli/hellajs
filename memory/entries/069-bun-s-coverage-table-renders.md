...
description: When bun's coverage table shows <100% lines with an EMPTY uncovered cell, re-run with --coverage-reporter=lcov and grep DA:0 entries; distrust a stale root coverage/lcov.info from earlier runs.
